...
- (Nov 21-25, 2022) - [LISA data analysis: from classical methods to machine learning](https://indico.in2p3.fr/event/27706/timetable/?view=standard)
...
- Machine learning CBC searches:
    ...
    - **[George & Huerta (2018) [@2018GeorgeDeepNeuralNetworks] (PRD)]** use a system of two deep convolutional neural networks to rapidly detect CBC signals. They use time series as input so that they can find signals too small for image recognition. They find their method significantly outperforms conventional machine learning techniques, achieves similar performance compared to matched-filtering while being several orders of magnitude faster.
        ...
        - Deep learning for real-time classification and regression of gravitational waves in real advanced LIGO noise. **[George & Huerta (2018) [@George2017pmj] (PLB) [@2017GeorgeDeepLearningRealtime] (1711.07966); George & Huerta (2018) [@George2017vlv] (NiPS Summer School)]**
    ...
    - **[Zhao et al. (2022) [@2022ZhaoSpacebasedgravitationalwave] (Communications Physics)]** - Space-Based Gravitational Wave Signal Detection and Extraction with Deep Neural Network
    ...
    - **[Garg et al. (2023) [@2023GargComparisonneuralnetwork] (PoS)]** - Comparison of Training Methods for Convolutional Neural Network Model for Gravitational-Wave Detection from Neutron Star-Black Hole Binaries
...
* Burst analysis
    ...
    - **[Meijer et al. (2023) [@2023MeijerGravitationalWaveSearchesCosmica] (2308.12323)]** - Gravitational-Wave Searches for Cosmic String Cusps in Einstein Telescope Data Using Deep Learning
...
- **[Liu & Max (2022) [@2022LiuMachinelearninghiddensymmetries] (PRL)]** - Machine-Learning Hidden Symmetries
